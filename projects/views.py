...
def home(request):
    """
    Single-page home: hero + project grid + channel widget +
    YouTube feed + contact + privacy, all in one.
    """
...
def project_list(request):
    """
    Legacy project‐list page (renders project_list.html).
    Useful if you ever need a standalone list.
    """
    projects = Project.objects.all()
